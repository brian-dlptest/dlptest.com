...
DLPTest.com provides several tools to test Data in Use scenarios, including an [HTTP(S) Post](/http-post/) test that simulates web-based data exfiltration.
...
- Web uploads via [HTTP(S)](/http-post/) post

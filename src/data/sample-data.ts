...
export const downloadFiles: DownloadFile[] = [
  ...
  { key: "sample-ssndob.csv",  label: "Sample SSN & DOB (CSV)",  group: "ssndob",   approxBytes: 4_600 },
  { key: "sample-ssndob.xls",  label: "Sample SSN & DOB (XLS)",  group: "ssndob",   approxBytes: 30_000 },
  { key: "sample-ssndob.xlsx", label: "Sample SSN & DOB (XLSX)", group: "ssndob",   approxBytes: 12_000 },
  { key: "sample-ssndob.pdf",  label: "Sample SSN & DOB (PDF)",  group: "ssndob",   approxBytes: 25_000 },
  { key: "sample-ccnzip.csv",  label: "Sample CCN & ZIP (CSV)",  group: "ccnzip",   approxBytes: 7_000 },
  { key: "sample-ccnzip.xls",  label: "Sample CCN & ZIP (XLS)",  group: "ccnzip",   approxBytes: 40_000 },
  { key: "sample-ccnzip.xlsx", label: "Sample CCN & ZIP (XLSX)", group: "ccnzip",   approxBytes: 15_000 },
  { key: "sample-ccnzip.pdf",  label: "Sample CCN & ZIP (PDF)",  group: "ccnzip",   approxBytes: 35_000 },
  { key: "sample-dobemail.csv",  label: "Sample DOB & Email (CSV)",  group: "dobemail", approxBytes: 7_000 },
  { key: "sample-dobemail.xls",  label: "Sample DOB & Email (XLS)",  group: "dobemail", approxBytes: 40_000 },
  { key: "sample-dobemail.xlsx", label: "Sample DOB & Email (XLSX)", group: "dobemail", approxBytes: 15_000 },
  { key: "sample-dobemail.pdf",  label: "Sample DOB & Email (PDF)",  group: "dobemail", approxBytes: 35_000 },
];

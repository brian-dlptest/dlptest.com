...
("U-02", B0, "Auto-discovery and classification of existing data",
 "You cannot write policy for data you have not found.",
 "Run discovery across endpoints and SaaS and review the inventory it produces before you write any policy.",
 "Advanced"),

("U-03", B0, "Classification explained in plain language",
...
# -------------------------------------------------------- AI Policy & Tuning
("U-04", B1, "Policy authored from a natural-language instruction",
...
("U-05", B1, "Policy recommendations from observed behaviour",
...
("U-06", B1, "Recurring recommendations digest",
 "Turns tuning into a standing 30-minute weekly task instead of a project.",
 "Confirm a scheduled digest exists - new risky destinations, policies to tighten, rules producing only false positives - and that it is actionable rather than a report.",
 "Advanced"),

("U-07", B1, "Simulation before enforcement",
...
("U-08", B1, "AI review of user override justifications",
...
# -------------------------------------------------------- AI Operations
("U-09", B2, "AI incident investigator",
...
("U-10", B2, "Intent inference, not just activity detection",
...
("U-11", B2, "Automated remediation with human-in-the-loop escalation",
...
("U-12", B2, "Natural-language / MCP interface for the security team",
...
("U-13", B2, "AI-generated reporting for executives and auditors",
...
("U-14", B2, "Mean time to triage an incident",
...
("U-15", B3, "Policy version history and one-click rollback",
...
("U-16", B3, "Staged rollout by group or device ring",
...
("U-17", B3, "Time to first meaningful detection",
...
# -------------------------------------------------------- Admin Experience
("U-18", B4, "Policies required to cover the use cases on this plan",
...
("U-19", B4, "Role-based administration and separation of duties",
 "Policy authors, approvers, and investigators should be different roles.",
 "Create an author who cannot approve and confirm the block holds.",
 "Table stakes"),

("U-20", B4, "Change approval workflow",
 "Block-mode changes deserve a second pair of eyes.",
 "Confirm a policy change can require approval before it reaches endpoints.",
 "Differentiator"),

# -------------------------------------------------------- End-User Experience
("U-21", B5, "Policy tip clarity",
...
("U-22", B5, "Business justification capture on warn",
...
("U-23", B5, "False-positive reporting from the endpoint",
...
# -------------------------------------------------------- Agent & Platform
("U-24", B6, "Agent resource footprint",
...
("U-25", B6, "User-visible latency on common actions",
...
("U-28", B6, "Offline enforcement and event queueing",
 "Laptops spend real time off the network.",
 "Go offline for 24 hours, trigger events, reconnect, and confirm nothing is lost.",
 "Table stakes"),

("U-29", B6, "Agent update cadence and rollback",
 "Agent updates are a fleet-wide change.",
 "Confirm you control update rings and can pin or roll back a version.",
 "Advanced"),
